 ...
 */
export const LogoutRequestDenied: FunctionComponent<
    LogoutRequestDeniedInterface
> = (props: LogoutRequestDeniedInterface): ReactElement => {
    const { errorMessage, handleLogin, handleLogout } = props;
